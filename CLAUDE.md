...
> Dự án: **Nhật ký Ba nhất** — Web app nộp và đọc nhật ký phong trào "3 Nhất" của Hội Phụ nữ Công an tỉnh Phú Thọ.
...
4. **Không hardcode secret/API key** vào source — dùng biến môi trường (`.env`).
