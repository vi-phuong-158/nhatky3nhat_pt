      ...
      <form onSubmit={handleSubmit} className="sf-form">
        ...
        <div className="sf-field">
          ...
          <div className="sf-input-wrapper">
            ...
            <input id="input-name" type="text" ref={nameRef} placeholder="Vd: Nguyễn Thị Lan" disabled={loading} required aria-required="true" aria-invalid={!!error} />
          </div>
        </div>
        ...
        <div className="sf-field">
          ...
          <div className="sf-input-wrapper">
            ...
            <input id="input-title" type="text" ref={titleRef} placeholder="Nhập tiêu đề..." disabled={loading} required aria-required="true" aria-invalid={!!error} />
          </div>
        </div>
        ...
        <div className="sf-field">
          ...
          <div className="sf-input-wrapper sf-select-wrapper">
            ...
            <select id="select-criteria" ref={criteriaRef} disabled={loading} required aria-required="true" aria-invalid={!!error}>
        ...
        {loading && uploadProgress > 0 && uploadProgress < 100 && (
          <div className="w-full bg-gray-200 rounded-full h-2.5 mb-4 mt-2" role="progressbar" aria-valuenow={Math.round(uploadProgress)} aria-valuemin="0" aria-valuemax="100">
